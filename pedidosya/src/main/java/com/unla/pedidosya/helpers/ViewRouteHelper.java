package com.unla.pedidosya.helpers;
...
public class ViewRouteHelper {
    ...
    public final static String MISPEDIDOSUSER = "usuario/misPedidos";
    ...
    public final static String EDITARNEGOCIO = "negocio/formModifN";
